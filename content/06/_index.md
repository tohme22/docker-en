...
[root@earth ~]# docker container run -it --dns 8.8.8.8 centos /bin/bash
...
nameserver 8.8.8.8
[root@81effa9b054b /]# exit

- Lets check it again without specifying DNS Server:
...
search localdomain
nameserver 192.168.181.2
[root@765ea2095dca /]# exit

- It has taken my Docker host DNS server settings. 
```
